  ...
  studies = [
    {
      ...
      description: '포트폴리오를 담은 웹어플리케이션. 사실 이 앱 자체가 그간 공부한 기술들을 총 동원하여 만든 포트폴리오입니다. 대단한 코드를 짠 것은 아니지만 React, Redux를 적극 활용하여 보았고, Animation은 CSS와 vanilla script로 구현했습니다. 차후엔 React-motion도 적용해 볼 예정입니다. 최선을 다하여 만들었기에 넘나 사랑스러운 나머지 하루에 300번씩 접속해서 가만히 바라보고 있습니다(...)',
      url: 'https://jinsol.kim/'
    },
    {
      title: 'Kakao Desktop Clone',
      img: 'https://i.imgur.com/zlQLGNd.png',
      description: 'HTML과 CSS 공부를 위해 카카오톡 앱 디자인을 따라해 본 Nomad Academy의 예제. 특히 CSS의 Flex 속성을 충분히 익히고 다룰 수 있어서 좋았습니다. 또한 CSS의 Display 속성 값 종류인 in-line과 block의 차이에 대해 익힐 수 있었고, 전체적으로 기본 페이지 구조를 구현하는데 큰 도움이 되었던 예제입니다.',
    ...
    },
    {
      ...
      description: '첫 React 실습 예제. 검색어를 입력하면 검색 항목들이 결과로 나타나고 그 중 하나를 클릭하면 중앙 화면이 해당 비디오로 바뀝니다. 한 페이지 안에서 특정 부분만 정보가 실시간으로 바뀌는 것을 보고 기절초풍! 사실 사용자 입장에서는 당연하다는 듯이 여기고 사용했던 기능이지만, 개발을 시작한 뒤로 새삼 신기하고 경이롭게 다가오는 기능, 기술들이 많습니다. 세상에는 정말 천재들이 가득합니다...',
