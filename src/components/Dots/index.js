...
export default class About extends Component {
  ...
  componentDidMount() {
    window.addEventListener("scroll", this.scrollYChecker);
      }
  

  componentWillUnmount() {
    window.removeEventListener("scroll", this.scrollYChecker);
  }
      ...
      <div className="about">
        ...
        <section className="scenes">
          ...
          <span className="prologue__title">BIOGRAPHY</span>
            <span className="prologue__subtitle">ABOUT<br /> DOTS</span>
          </div>
