  ...
  return (
    <div className="home">
      ...
      <div className="home__skills">
        <div className="home__skill"><span>HTML</span></div>
        <div className="home__skill"><span>CSS</span></div>
        <div className="home__skill"><span>JavaScript</span></div>
        <div className="home__skill"><span>and React</span></div>
        </div>
    </div>
  );
};
...
window.onload = function activatehome() {
  document
    .querySelector(".home")
    .classList.add("home--active");
};